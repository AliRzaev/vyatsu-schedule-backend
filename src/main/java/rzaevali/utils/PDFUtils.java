...
public class PDFUtils {
    private static final String BASE_URL = "https://www.vyatsu.ru/reports/schedule/Group/%s_1_09102017_22102017.pdf";

    private static class Entity {
        private List<List<List<String>>> weeks;
        private String group;

        Entity(List<List<List<String>>> weeks, String group) {
            this.weeks = weeks;
            this.group = group;
        }
    }

    public static String parseSchedule(String groupId) throws IOException {
        URL url = new URL(String.format(BASE_URL, groupId));
